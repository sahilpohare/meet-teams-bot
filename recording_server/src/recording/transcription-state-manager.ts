...
export class TranscriptionStateManager {
    ...
    private readonly chunksPerTranscription: number = MEETING_CONSTANTS.CHUNKS_PER_TRANSCRIPTION;
    ...
    public addChunk(timestamp: number): TranscriptionSegment | null {
        ...
        if (this.chunkCount % this.chunksPerTranscription === 0) {
            ...
            const startTime = (this.chunkCount - this.chunksPerTranscription) * this.chunkDuration;
    ...
    public finalize(): TranscriptionSegment | null {
        ...
        const startTime = (this.chunkCount - remainingChunks) * this.chunkDuration;
