...
import { createTranscoder } from '../../recording/Transcoder';
...
export class InCallState extends BaseState {
    ...
    private async initializeServices(): Promise<void> {
        ...
        // Démarrer le Transcoder
        this.context.transcoder = createTranscoder(this.context.params.bot_uuid);
        await this.context.transcoder.start();
    }
